    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center px-2 sm:px-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-md mx-auto p-4 sm:p-8 flex flex-col items-center animate-fadeIn">
        ...
        <button
          ...
          className="flex items-center justify-center w-full bg-tomatoHover text-white font-semibold rounded-lg px-4 sm:px-6 py-3 text-base sm:text-lg shadow hover:bg-tomato active:bg-tomato/80 transition-colors duration-150"
        >
